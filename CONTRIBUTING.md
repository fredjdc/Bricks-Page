# Bricks Page Contributing

Local repo guidance for Bricks Page contributors.
...
The local `docs/` folder is reserved for repo-specific workflow docs only.

Do not add canonical product or engineering docs in this repo.
